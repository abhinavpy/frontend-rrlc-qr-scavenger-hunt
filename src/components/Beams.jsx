...
const Beams = ({
  ...
  vec3 getNormal(vec3 pos) {
    ...
    // Create brown to black gradient based on position
    float gradientFactor = smoothstep(-0.5, 0.5, vUv.y + sin(time * 0.5) * 0.3);
    vec3 blackColor = vec3(0.0, 0.0, 0.0);
    diffuseColor.rgb = mix(blackColor, uBrownColor, gradientFactor);
    `,
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB("#593C1B")),
          ...
          uScale: scale,
          uBrownColor: new THREE.Color(...hexToNormalizedRGB("#593C1B")),
        },
      }),
